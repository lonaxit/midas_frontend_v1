...
<script>
  ...
  import QrcodeVue from 'qrcode.vue'
    ...
    generateReport(){
	  ...
	  ...mapActions(['Me','getUserDetail','myDepositStatement','OpeningBalance']),  
		}
	}
</script>
